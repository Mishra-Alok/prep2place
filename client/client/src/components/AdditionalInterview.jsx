...
Format the response with bold headings (e.g., **Key Strengths Demonstrated:**) and ensure it is well-formatted in points. Do not use * marks.`;
  ...
  const renderJobInput = () => (
    <div className="bg-white dark:bg-gray-800 min-h-[calc(100vh-4rem)] w-full flex flex-col items-center justify-center p-4 transition-colors duration-200">
      <h1 className="text-4xl font-bold text-purple-600 mb-8 mt-8">Custom Interview Preparation</h1>
  ...
  const renderInterviewStage = () => (
    <div className="bg-white dark:bg-gray-800 min-h-[calc(100vh-4rem)] w-full flex items-center justify-center p-4 lg:p-8 transition-colors duration-200">
      <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-12 gap-8">

        <div className="col-span-1 lg:col-span-6 bg-purple-100 rounded-lg overflow-hidden h-[400px] lg:h-[600px] shadow-xl">
          <video 
            ref={videoRef} 
            autoPlay 
            muted 
        ...
        <div className="col-span-1 lg:col-span-6 bg-purple-50 rounded-lg p-6 flex flex-col shadow-xl min-h-[400px] lg:h-[600px] overflow-y-auto">
  ...
  const renderOverallFeedback = () => (
    <div className="bg-white dark:bg-gray-800 min-h-[calc(100vh-4rem)] w-full flex flex-col items-center justify-center p-4 lg:p-8 transition-colors duration-200">
      <h1 className="text-4xl font-bold text-purple-600 mb-8 mt-8">Interview Feedback</h1>
